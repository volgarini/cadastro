            ...
            <div class="tab-content">
                <div class="tab-pane active" id="access">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="nome" value="" id="nome" class="form-control" placeholder="Entre com o Nome">                
                        </div>  
                    </div>
                    <div class="form-group">
                        <label for="endereco" class="col-sm-1 control-label">Endereço: </label>
                        <div class="col-sm-3">
                            <input type="text" name="endereco" value="" id="endereco" class="form-control" placeholder="Entre com o Endereço">                
                        </div>  
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-sm-1 control-label">Email: </label>
                        <div class="col-sm-3">
                            <input type="text" name="email" value="" id="email" class="form-control" placeholder="Entre com o Email">                
                        </div>  
                    </div>
                    <div class="form-group">
                        <label for="telefone" class="col-sm-1 control-label">Telefone Fixo: </label>
                        <div class="col-sm-3">
                            <input type="text" name="telefone" value="" id="telefone" class="form-control" placeholder="Entre com o Telefone Fixo">                
                        </div>  
                    </div>
                    <div class="form-group">
